...
const AdminView = ({
  ...
  // Rollback confirmation is now owned by the parent's useConfirm hook —
  // calling handleDeleteSilentImports() opens the modal automatically.
...
firstname.lastname@gardenerschools.com,Annual Leave,2025-11-05,2025-11-06,2`}
          ...
          {silentImportCount > 0 && (
            <div className="mt-4 pt-4 border-t border-gray-200 flex items-center justify-between">
              ...
              <button
                onClick={handleDeleteSilentImports}
